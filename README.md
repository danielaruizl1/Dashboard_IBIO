...
En la carpeta _**Data**_ se encuentran diferentes archivos que permitirán construir las diferentes gráficas del Dashboard IBIO.
  ...
  - **Cursos 201810-202510.xlsx:** Contiene la información de todos los cursos desde 2018-10 hasta el periodo actual. Esta información corresponde a los registros de los cursos, por lo que cada estudiante aparecerá tantas veces como en cursos esté inscrito por periodo. 
  - **Estudiantes IBIO 201810-202510.xlsx:** Contiene la información de todos los estudiantes IBIO desde 2018-10 hasta el periodo actual. Cada hoja corresponde a un periodo académico y contiene el listado de estudiantes que tienen inscrito el programa de Ingeniería Biomédica en dicho semestre.
  - **Retiros 201810-202420.xlsx:** Contiene la información histórica de todos los retiros desde 2018-10 hasta el periodo actual.
  - **Estudiantes Sancionados 2021-10.xlsx:** Contiene la información de los estudiantes sancionados en 2021-10.


### Jupyter Notebook

El archivo [Dashboard_IBIO_notebook.ipynb](https://github.com/danielaruizl1/Dashboard_IBIO/blob/main/Dashboard_IBIO_notebook.ipynb) contiene varias celdas ejecutables, cada una diseñada para generar un conjunto distinto de gráficas. Es importante ejecutar las celdas en el **orden indicado**, haciendo clic en el botón con el símbolo _play_.
<p align="center">
...
También es posible obtener todos los resultados simultáneamente al ejecutar el archivo [dashboard.py](https://github.com/danielaruizl1/Dashboard_IBIO/blob/main/dashboard.py) desde la terminal:
...
En este caso, se creará una carpeta para cada periodo donde se encontrarán los piecharts para cada una de las cohortes.
<p align="center">
